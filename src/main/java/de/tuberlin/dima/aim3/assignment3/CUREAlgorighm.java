...
public class CUREAlgorighm {
  ...
  public static void main(String[] args) throws Exception {
    ...
    DataSet<Tuple2<Double, Double>> nextWorkset =
        candidatesAndMinDistances.<Tuple2<Double, Double>>project(0, 1)
  ...
  private static class MinDistanceToInitials
    ...
    public Tuple3<Double, Double, Double> map(Tuple2<Double, Double> value) throws Exception {
      ...
      System.out.println("min for (" + value.f0 + ","+  value.f1 + "):" + minDistance);
   ...
   */
  private static class RemoveCandidate extends RichGroupReduceFunction<Tuple2<Double, Double>, Tuple2<Double, Double>> {
